...
const product_data: IProduct[] = [
  {
    id: 1,
    sku: "WH001",
    title: "Rustic Wooden House",
    unit: "piece",
    imageURLs: [
      "/assets/img/banner/wooden-houses-banners/home-banner-1.jpg",
      "/assets/img/banner/wooden-houses-banners/home-banner-1.jpg"
    ],
    ...
    status: "available",
    productType: "house",
    description: "A beautiful rustic wooden house perfect for a countryside retreat. It features a cozy interior with modern amenities.",
    additionalInformation: {
      dimensions: "10x12 meters",
      material: "Pine wood",
      rooms: 3
    },
    sizes: null,
  ...
  },
  {
    ...
    unit: "piece",
    imageURLs: [
      "/assets/img/banner/wooden-houses-banners/home-banner-2.jpg",
      "/assets/img/banner/wooden-houses-banners/home-banner-2.jpg"
    ],
    parent: "wooden-houses",
    price: 250000,
    ...
    status: "available",
    productType: "villa",
    description: "A luxurious modern wooden villa with spacious rooms and an elegant design. Ideal for upscale living.",
    additionalInformation: {
  ...
  },
  {
    ...
    unit: "piece",
    imageURLs: [
      "/assets/img/banner/wooden-houses-banners/home-banner-3.jpg",
      "/assets/img/banner/wooden-houses-banners/home-banner-3.jpg"
    ],
    parent: "wooden-houses",
    price: 100000,
    ...
    status: "available",
    productType: "cabin",
    description: "An eco-friendly wooden cabin built with sustainable materials. Perfect for nature lovers.",
    additionalInformation: {
      dimensions: "8x10 meters",
  ...
  },
  {
    ...
    brand: "CompactHomes",
    status: "available",
    productType: "bungalow",
    description: "A compact wooden bungalow designed for small families. Offers a warm and inviting atmosphere.",
    additionalInformation: {
      dimensions: "12x10 meters",
      material: "Cedar wood",
      rooms: 3
    },
    sizes: null,
    ...
    tags: ["compact", "small-family", "inviting"],
    videoId: "jkl012",
    categoryId: 1,
    orderQuantity: 0
  },
  {
    id: 5,
    sku: "WH005",
    title: "Luxury Wooden Mansion",
    unit: "piece",
    imageURLs: [
      "/assets/img/banner/wooden-houses-banners/home-banner-4.jpg",
      "/assets/img/banner/wooden-houses-banners/home-banner-4.jpg"
    ],
    parent: "wooden-houses",
    price: 500000,
    ...
    status: "available",
    productType: "mansion",
    description: "A grand luxury wooden mansion with exquisite design and top-notch amenities. Perfect for a lavish lifestyle.",
    additionalInformation: {
      dimensions: "30x25 meters",
      material: "Teak wood",
      rooms: 10
    },
    sizes: null,
